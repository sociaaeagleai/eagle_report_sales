...
const AdminDataView = () => {
  ...
  const applyFilters = () => {
    ...
    if (filters.selectedSources.length > 0) {
      filtered = filtered.filter(s => filters.selectedSources.includes(s.source));
    }
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredSubmissions.map((submission) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge variant="outline" className="text-xs">{submission.source}</Badge>
                          </TableCell>
                          <TableCell>
                    ...
                    {filteredSubmissions.length > 0 && (() => {
                      ...
                      const uniqueSourcesCount = new Set(filteredSubmissions.map(s => s.source)).size;
